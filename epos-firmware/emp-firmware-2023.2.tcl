...
#
# emp-firmware-2023.2.tcl: Tcl script for re-creating project 'emp-firmware-2023.2'
#
# Generated by Vivado on Wed Nov 20 10:47:26 CET 2024
...
#
# 1. This project restoration tcl script (emp-firmware-2023.2.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/home/decker/Documents/vivadoProj/master/emp-firmware/emp-firmware-2023.2/emp-firmware-2023.2.srcs/sources_1/bd/emp_fw_TE0807/emp_fw_TE0807.bd"
#    "/home/decker/Documents/vivadoProj/master/emp-firmware/emp-firmware-2023.2/emp-firmware-2023.2.srcs/constrs_1/imports/new/emp_transceivers_TE0807.xdc"
#    "/home/decker/Documents/vivadoProj/master/emp-firmware/emp-firmware-2023.2/emp-firmware-2023.2.srcs/constrs_1/imports/new/emp_async_clocks.xdc"
#    "/home/decker/Documents/vivadoProj/master/emp-firmware/emp-firmware-2023.2/emp-firmware-2023.2.srcs/utils_1/imports/synth_1/emp_fw_TE0807_wrapper.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/emp-firmware-2023.2/emp-firmware-2023.2.srcs/sources_1/bd/emp_fw_TE0807/emp_fw_TE0807.bd"]"\
 "[file normalize "$origin_dir/emp-firmware-2023.2/emp-firmware-2023.2.srcs/constrs_1/imports/new/emp_transceivers_TE0807.xdc"]"\
 "[file normalize "$origin_dir/emp-firmware-2023.2/emp-firmware-2023.2.srcs/constrs_1/imports/new/emp_async_clocks.xdc"]"\
 "[file normalize "$origin_dir/emp-firmware-2023.2/emp-firmware-2023.2.srcs/utils_1/imports/synth_1/emp_fw_TE0807_wrapper.dcp"]"\
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "emp-firmware-2023.2"
...
set script_file "emp-firmware-2023.2.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/emp-firmware-2023.2"]"
...
if { [get_property IS_LOCKED [ get_files -norecurse emp_fw_TE0807.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/emp-firmware-2023.2/emp-firmware-2023.2.gen/sources_1/bd/emp_fw_TE0807/hdl/emp_fw_TE0807_wrapper.vhd" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse emp_fw_TE0807.bd] -top]
...
set file "emp_fw_TE0807/emp_fw_TE0807.bd"
...
set_property -name "top" -value "emp_fw_TE0807_wrapper" -objects $obj
...
set file "[file normalize "$origin_dir/emp-firmware-2023.2/emp-firmware-2023.2.srcs/constrs_1/imports/new/emp_transceivers_TE0807.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "new/emp_transceivers_TE0807.xdc"
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/emp-firmware-2023.2/emp-firmware-2023.2.srcs/constrs_1/imports/new/emp_async_clocks.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "new/emp_async_clocks.xdc"
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
...
set file "synth_1/emp_fw_TE0807_wrapper.dcp"
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/emp-firmware-2023.2.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "auto_rqs.directory" -value "$proj_dir/emp-firmware-2023.2.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/emp-firmware-2023.2.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
